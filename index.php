		...
		<div id="wrapper">
			...
			<div id="menuwrapper">
                ...
                <ul id="css3menu1" class="topmenu">
                    ...
                    <li><a href="olc/olc_app/login.php">Login to Application</a></li>
                </ul>
                <!-- End menu section -->
            ...
            <div id="sliderwrapper">
				...
				<div id="maincontent">
					...
					<div style="padding:8px;">
					  <p align="right"><img src="images/profile.jpg" alt="My Photo" width="182" height="182"></p>
					  <p>Heartly welcome to my page <a href="http://www.pandayarjun.com.np">pandayarjun.com.np.</a><br />
					Feel friendly! <br />
					I am a web designer, developer, and freelance worker since 2010. See <a href="profile.php">more.. &gt;&gt;</a>
					</p><hr />
					</div>
						...
						<h3><u>Web Designing</u></h3>
							...
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
									It is the process of combining, arranging and implementing different components together for the website design. It combines HTML, CSS, Java Scrit, JQuery, AJAX, PHP, ASP.Net, C#, Java, MySql, Oracle etc. Designer/programmer/developer chooses required components and combines to form a website. 
								</p><hr/>
							</div>
					...
					<div style="padding:10px;">
						<h3><u>Web Development</u></h3>
							...
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
								Same components are integrated to develop and design the website. But such sort of website are related to application. It means to say that it related to software that communicates with any database.
								</p><hr/>
							</div>
							
					<div style="padding:10px;">
						<h3><u>Graphic Design</u></h3>
					</div>
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
								Here mostly printing related document are desined. Logo design, banner design, books cover design etc. falls under this section.
								</p><hr/>
							</div>
									
					<div style="padding:10px;">
						<h3><u>Hardware & Networking</u></h3>
					</div>
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
									If you have any Inquery regarding hardware and software problem you are free to call me for query.
								</p><hr/>
							</div>
