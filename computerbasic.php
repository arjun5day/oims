...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Download Comuter Notes, Hardware Note, Graphic Note, Programming Note, Web Design Note, Accounting Note, Tally Note</title>
		<meta name="description" content="Download Comuter Notes, Hardware Note, Graphic Note, Programming Note, Web Design Note, Accounting Note, Tally Note">
		<meta name="abstract" content="Download Comuter Notes, Hardware Note, Graphic Note, Programming Note, Web Design Note, Accounting Note, Tally Note">
		...
		<meta name="google-translate-customization" content="19bfe6657caf16da-89e0665328cec809-g079712f9219b8962-16"></meta>
		...
		<div id="wrapper">
            ...
            <div id="sliderwrapper">
				...
				<div id="maincontent">
					...
					<h1> Download Comuter Notes/ Web Designing Note/ Hardware Notes/ Tally Note</h1>
						<h3><u> Basic Computer Note for Microsoft Word</u></h3>
					</div>
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
									It is an application software developed by Microsoft Cooperation of USA. This software helps us to create and design bio-data, reports, letters, and application and so on.
								</p>
								Process to Open Microsoft Word:<br />
								<ul>
									<li>Click on start button</li>
									<li>Go to all programs</li>
									<li>Click on Microsoft office</li>
									<li>Click on Microsoft office word </li>or
									<li>Click on start button</li>
									<li>Click on run</li>
									<li>Type <u>winword</u></li>
									<li>Hit enter key </li>						
								</ul>
								<div class="download"><a href="document/word.docx">Download</a></div>
								<hr/>
							</div>
							
							
					<div style="padding:10px;">
						<h3><u> Basic Computer Note for Microsoft Excel</u></h3>
					</div>
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
Microsoft Excel is a powerful tool used to create and format spreadsheet. MS Excel is a Spreadsheet Package which allows building the mathematical relationship between rows and columns. It helps us to store and manipulate the data. Each excel worksheet consists of 256 columns and 65,536 rows. The File Created in excel is Workbook. The default extension of workbook is “.xls or xlsx”.
								</p>
								Process to Open Microsoft Excel:<br />
								<ul>
									<li>Click on start button</li>
									<li>Go to all programs</li>
									<li>Click on Microsoft office</li>
									<li>Click on Microsoft office Excel </li>or
									<li>Click on start button</li>
									<li>Click on run</li>
									<li>Type <u>Excel</u></li>
									<li>Hit enter key </li>						
								</ul>
								<div class="download"><a href="document/excel.docx">Download</a></div>
								<hr/>
							</div>
							
					<div style="padding:10px;">
						<h3><u>Basic Computer Note for PowerPoint </u></h3>
					</div>
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
								It is application software developed by Microsoft cooperation of USA currently most commonly visual aids for presentations. This software is used to design presentation and slides where different types of animation are applied.
								</p>
								<div class="download"><a href="document/powerpoint.docx">Download</a></div>
							<hr/>
							</div>
									
					<div style="padding:10px;">
						<h3><u>Basic Computer Note for Email &amp; Internet:</u></h3>
					</div>
							<div style="padding:8px">
								<p style="padding:0px 8px 0px 8px;">
									Internet is a network of computers which are connected with each other for data, resource, device and information sharing and communication.
									E-mail= Electronic Mail<br />
									URL=Uniform Resource Locator<br />
									WWW = World Wide Web

								</p>
								<div class="download"><a href="document/emailinternet.docx">Download</a></div>
								<hr/>
							</div>
				...
				<div id="rightaside">
					...
					<ul>
						<li><a href="http://lamjungnews.com/">Lamjung News</a></li>
						<li><a href="http://landlark.com/">Land Lark Pvt. Ltd.</a></li>
						<li><a href="http://himalayanbeads.com/">Himalayan Beads Cottage Pvt. Ltd.</a></li>
						<li><a href="http://friendofworkers.com/">Friend of Workers</a></li>
					</ul>
				</div><!--rightaside close-->
